...
g <- g + geom_point(data=firedata1, aes(x=as.double(period), y=wildfire_emissions, fill = "Fires during REDD+"), size=2, shape=23) + 
  ...
  geom_point(data=firedata2, aes(x=as.double(period), y=wildfire_emissions, fill = "Fires pre-REDD+"), size=2, shape=23) + 
